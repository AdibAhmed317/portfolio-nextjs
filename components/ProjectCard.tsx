...
const ProjectCard = ({
  ...
  return (
    ...
    >
      <section
        className="text-start bg-gray-100 md:max-w-[47rem] border border-black/5 overflow-hidden pr-0
        md:pr-8 relative md:h-[25rem] hover:bg-gray-200 transition rounded-lg dark:bg-white/10 dark:hover:bg-white/20"
      >
        <div
          ...
          <div>
            <div className="my-5 flex justify-between">
              <a
                target="_blank"
                href="/"
                className="bg-white/[0.7] px-3 py-1 text-[0.7rem] uppercase tracking-wider text-black rounded-full mr-2"
              >
                Github
              </a>
              <a
        ...
        <Image
          ...
          alt="project image"
          quality={95}
          className="absolute top-[40px] -right-60 md:-right-80 h-full w-auto md:h-full md:w-[40rem] rounded-lg shadow-2xl
          group-even:right-80 
          group-even:-left-60 
